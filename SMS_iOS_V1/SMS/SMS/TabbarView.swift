...
class CustomMenuBar: UIView {
    ...
    func setupCollectioView(){
        ...
        customTabBarCollectionView.register(UINib(nibName: TabbarCell.reusableIdentifier, bundle: nil), forCellWithReuseIdentifier: TabbarCell.reusableIdentifier)
...
extension CustomMenuBar: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: TabbarCell.reusableIdentifier, for: indexPath) as! TabbarCell
        return cell
    }
