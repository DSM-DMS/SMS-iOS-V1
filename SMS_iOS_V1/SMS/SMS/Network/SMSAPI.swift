...
enum SMSAPI {
    ...
    case searchNotice(_ searchText: String)
}
...
extension SMSAPI {
    ...
    var uuid: String {
        return UD.value(forKey: "uuid") as! String
    }
    
    var outing_uuid: String {
        return UD.value(forKey: "outing_uuid") as! String
    }
    ...
    var path: String {
        ...
        case .detailNotice(let announcement_uuid):
